...
def INQ_device_general_status_parameters(inverter):
    ...
    return {
        ...
        "ac_output_frequency": float(ac_output_frequency),
        "ac_output_apparent_power": float(ac_output_apparent_power),
        ...
        "pv1_input_current": float(pv1_input_current),
        "pv1_input_voltage": float(pv1_input_voltage),
        "battery_voltage_from_scc": float(battery_voltage_from_scc),
        "device_status": device_status,
        "load_status": load_status,
        "battery_voltage_offset_for_fans_on": float(battery_voltage_offset_for_fans_on),
